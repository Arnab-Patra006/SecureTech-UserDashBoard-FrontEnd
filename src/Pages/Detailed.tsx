...
const Detailed = () => {
  //I think you are not needed for now useStore is more than enough
  ...
  // // console.log(Id);
  // const allUser = useStore.getState().allUser;
  // // console.log(allUser);
  // const parseId = Id ? parseInt(Id) : null;

  // const userExists = allUser.find((user) => user.id === parseId); //Let's try...........
  // console.log(userExists);
  // const pleaseGiveMeMyCurrentUser=useStore.getState().currentUser; //worked
  // console.log(pleaseGiveMeMyCurrentUser);//worked
